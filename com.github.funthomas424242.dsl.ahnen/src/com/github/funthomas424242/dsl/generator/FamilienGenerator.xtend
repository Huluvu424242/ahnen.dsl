...
«««		    </partintro>
«««		    
«««		    «FOR rezept : familie.rezepte»
«««		    	«val rezeptIndex = familie.rezepte.indexOf(rezept)»
«««			<xi:include href="Rezept_«parentIndex+'_'+rezeptIndex».dbk" />
«««			«fsa.generateFile(RezeptGenerator.getDbkFileName(buch, "Rezept_"+parentIndex+'_'+rezeptIndex+".dbk"),
«««			createChapter(fsa,buch,rezept, parentIndex+" "+rezeptIndex))»
«««			«ENDFOR»
		</part>
	'''

//	def static createChapter(IFileSystemAccess fsa, Familienbuch buch, Familie familie, String rezeptIndex) '''
...
// 
// <chapterinfo>
// 	<pubdate>«familie.letzteAenderung» </pubdate>
// </chapterinfo>
// 
//<title>«familie.titel»</title>
//«IF familie.untertitel != null»
//	<subtitle>«familie.untertitel»</subtitle>
//«ENDIF»
//
//<para>
//	<variablelist>
